...
function initFileToolbar() {
    ...
    var uploadFile = new CToolbarIcon({ id: "re_func_upload", title: i18n['tabicon']['UploadPDF'], event: 'ShowUploadDialog("pdf");', cssClass: "" });
    fileUpIconGroup.addIcon(uploadFile);
    var onlineFile = new CToolbarIcon({ id: "re_func_online", title: i18n['tabicon']['OpenPDF'], event: 'ShowOnlineDialog("others");', cssClass: "" });
    fileUpIconGroup.addIcon(onlineFile);
    var otherFile = new CToolbarIcon({ id: "re_func_files", title: i18n['tabicon']['CreatePDFFromOther'], event: 'ShowUploadDialog();', cssClass: "" });
...
function initViewToolbar() {
    ...
    var cursorIcon = new CToolbarIcon({ id: "re_func_arrowCur", title: i18n['tabicon']['Arrow'], event: 'ArrowEvent();', cssClass: "re_func_arrowCur " });
