...
function initFileToolbar() {
    ...
    var uploadFile = new CToolbarIcon({ id: "re_func_upload", title: i18n['tabicon']['UploadFile'], event: 'ShowUploadDialog("pdf");', cssClass: "" });
    fileUpIconGroup.addIcon(uploadFile);
    var onlineFile = new CToolbarIcon({ id: "re_func_online", title: i18n['tabicon']['OpenFile'], event: 'ShowOnlineDialog("others");', cssClass: "" });
